...
const devs = [
    { name: 'alesyakuptsova', color: '#00bbf9' },
    { name: 'lemeshkonastya', color: '#fee440' },
    { name: 'spanb4', color: '#9b5de5' },
    { name: 'magklax', color: '#f15bb5' },
];
